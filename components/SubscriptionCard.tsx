...
const SubscriptionCard = ({name, price, currency, icon, billing,color, category, plan, paymentMethod,
                              renewalDate,onPress, expanded, startDate, status}:SubscriptionCardProps) => {
    return (
        //clsx used to apply conditional color background for subscription card
        //Pressable - make card interactive
